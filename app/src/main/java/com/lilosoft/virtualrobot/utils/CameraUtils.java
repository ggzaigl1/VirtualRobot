...
public class CameraUtils {
     ...
     * @param expectFps
     */
    public static void openFrontalCamera(int expectFps, SurfaceHolder holder) {
        if (mCamera != null) {
            throw new RuntimeException("camera already initialized!");
        }
...
//        mCamera.setDisplayOrientation(mOrientation);
     ...
     * 开始检测脸
     */
    public static void actionDetect(Camera.PreviewCallback mView) {
        if (mCamera != null) {
            mCamera.setPreviewCallback(mView);
        }
    }
